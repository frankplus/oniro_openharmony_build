...
import os
import argparse
from gen_def_from_all_yaml import merge_hisysevent_config
...
def _get_install_info(hisysevnet_config_files, output_path,
    ...
    if hisysevent_config_files:
        ...
        _install_dest = os.path.join(config_install_dest_dir,
...
def main(argv):
    ...
    hisysevent_config_files = _get_all_config_files(hisysevent_config_info,
        src_part_list, args.source_root_dir, args.gn_root_build_dir)
    ...
    install_info_list = _get_install_info(hisysevent_config_files,
        _output_path, args.config_install_dest_dir)
